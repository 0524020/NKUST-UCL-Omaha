...
const TCHAR* const kRegValueServiceName           = _T("uclab_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("uclabm_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("uclab_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("uclab_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("uclab");
const TCHAR* const kMediumServicePrefix         = _T("uclabm");
